...
This project is **NOT** the official MeshLib repository.

It is a fork of MeshLib sources hosted at https://github.com/NIRALUser/MeshLib.
...
How to update the version of MeshLib ?
------------------------------------------

1. Clone this repository and add a remote to the official project

```
git clone git://github.com/slicersalt/MeshLib
cd MeshLib
git remote add upstream git://github.com/NIRALUser/MeshLib
git fetch upstream
```
...
6. Update projects that use slicersalt/MeshLib and submit a pull request.
